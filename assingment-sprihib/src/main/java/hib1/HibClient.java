...
public class HibClient {
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext context = new ClassPathXmlApplicationContext("tx-hib-ann.xml");
...
//    }
   ...
   //      Update Inventory Item
        ...
        inventoryService.removeItem(retrievedItem.getId(), 2);

        System.out.println(" Removed item 2 from inventory.");
...
////		Customer c1= new Customer("Rahul",23,"JAI","RAJ");

////		Customer c2= new Customer("Saini",23,"BLR","KAI");

////		Customer c3= new Customer("Badal",21,"DEL","DUI");

////		Customer c4= new Customer("Fenil",22,"AMR","HMT");
