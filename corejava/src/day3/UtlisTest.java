...
class UtlisTest {
		...
		public class Point implements Comparable<Point>{
			...
			private UtlisTest getEnclosingInstance() {
				return UtlisTest.this;
			}
		...
		public void testArrayList() {
			tryingLists(new ArrayList<UtlisTest.Point>());
			tryingLists(new LinkedList<UtlisTest.Point>());
		}
		...
		public void testHashSet() {
			tryingSets(new HashSet<UtlisTest.Point>());
		...
		public void testTreeSet() {
			...
			tryingSets(new TreeSet<UtlisTest.Point>());
